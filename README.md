...
Upon successful completion, you should find under your local folder `experiments` an identical version of the content in our publicly available [artifacts and results for the replication package](https://zenodo.org/records/10963043).
